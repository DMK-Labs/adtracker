      ...
      [ant/row
       [ant/card
        ...
        [:div [ant/select {:defaultValue @value
         ...
         [:ul
          [:li (str @value "위 비용: ") (u/krw (u/sum (keyword (str @value "-cost")) data))]
          [:li (str @value "위 노출수: ") (u/int-fmt (u/sum (keyword (str @value "-impressions")) data))]
          [:li (str @value "위 클릭수: ") (u/int-fmt (u/sum (keyword (str @value "-clicks")) data))]]]
        (if data
          [ant/table
           {:scroll     {:x 2500}
